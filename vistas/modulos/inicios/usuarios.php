    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" method="POST" enctype="multipart/form-darta">
                <!-- diferencia los datos de imagen -->
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nuevoUsuario" placeholder="Nombre de usuario" required>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" name="nuevaClave" placeholder="Contraseña" required>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="card mb-3">
                                    <div class="row no-glutters">
                                        <div class="col-md-4">
                                            <img src="vistas/dist/img/user2-160x160.jpg" class="img-circle elevation-2 img-xl previsualizar" alt="fotoUsuario" width="150">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body text-info">
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input nuevaFoto" name="nuevaFoto" id="nuevaFoto">
                                                        <label class="custom-file-label" for="nuevaFoto">
                                                            Elegir foto
                                                        </label>
                                                    </div>
                                                    <div class="input-group-append">
                                                ...
                                                <p class="card-text">
                                                    <small class="text-muted">Peso maximo 2Mb</small>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
